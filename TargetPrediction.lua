...
counter = -3;                                  -- effectively value of 40Hz clock
clock = -3;                                    -- increments every physics step [40 Hz]
...
laserTargeterIndexes = {};                     -- Stores Laser Targeter Indexes of each weapon index (taken from user: AcaNexa - Animesupplier)
laserTargeterType = {};                        -- ammending method to handle CRAM targeters

function Update(I)
   if clock == -3 then                            -- Initialize Laser Targeter Indexes (taken from user: AcaNexa - Animesupplier)
      for idx = 0, I:Component_GetCount(13) - 1 do
         Widx = I:Component_GetIntLogic(13,idx);
         laserTargeterIndexes[Widx] = idx;
         laserTargeterType[Widx] = 13;
      end
      for idx = 0, I:Component_GetCount(14) - 1 do
         Widx = I:Component_GetIntLogic(14,idx);
         laserTargeterIndexes[Widx] = idx;
         laserTargeterType[Widx] = 14;
      end
   end
   ...
   -- See end of script for target data
         ...
         --Fire Turret
            ...
            -- Determine temporal error
               ...
               -- Find Position of target in previous raw travel time
                  ...
                  FZRng = CZRng + FZdispV + FZdispA + FZdispJ;  -- Future dZ
            ...
            -- Find target aimpoint
               ...
               TZRng = CZRng + TZdispV + TZdispA + TZdispJ;  -- Target dZ
            ...
            -- Aim Turret in this direction
               ...
               AimErr = Vector3(TXRng,Ydir,TZRng);
               AimErr = AimErr.normalized - info.CurrentDirection;
               CDir = info.CurrentDirection;
            -- If Laser Targetter Present: (taken from user: AcaNexa - Animesupplier)
               LTI = laserTargeterIndexes[idx];
               if LTI then
                  I:Component_SetFloatLogic(laserTargeterType[idx], LTI, TT);
               end
   ...
   if counter == freq-1 then
      ...
      counter = -1;                                -- Resets Counter every cycle
